		...
		<header className="sticky top-0 z-20 border-b border-border-subtle bg-bg-glass backdrop-blur-xl">
			<div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
				...
				<span className="flex gap-2">
					<span className="hidden rounded-full border border-border-default px-3 py-1 font-mono text-xs text-foreground-muted sm:block hover:bg-black/40 hover:font-bold cursor-pointer">
						API key
					</span>
					<span className="hidden rounded-full border border-border-default px-3 py-1 font-mono text-xs text-foreground-muted sm:block hover:bg-black/40 hover:font-bold cursor-pointer">
						Get Extension
